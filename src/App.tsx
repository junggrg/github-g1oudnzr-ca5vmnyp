...
import { Bot, Brain, User, Calendar, Clock, Zap, Settings } from 'lucide-react';
import { supabase, ConsultationData } from './lib/supabase';
import { Toast } from './components/Toast';
import { ThankYouScreen } from './components/ThankYouScreen';
import { OrbitalAutomationCategories } from './components/OrbitalAutomationCategories';
import { LimelightNav } from './components/LimelightNav';
import StellarCardGallery from './components/StellarCardGallery';
...
function App() {
  ...
  return (
    <div className="bg-black text-white overflow-x-hidden">
      ...
      <section className="min-h-screen flex items-center justify-center relative overflow-hidden">
        ...
        <div className="absolute top-6 right-4 sm:top-8 sm:right-8 z-20">
          <button 
            ...
            className="glass-button mobile-book-button md:px-6 md:py-3 md:text-base font-semibold hover:scale-105 transition-transform"
          >
      ...
      {/* Orbital Automation Categories */}
      <OrbitalAutomationCategories />
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  ...
                  >
                    ...
                    <option value="customer-facing">CUSTOMER-FACING AUTOMATIONS</option>
                    <option value="ecommerce">E-COMMERCE AUTOMATIONS</option>
                    <option value="sales-marketing">SALES & MARKETING AUTOMATIONS</option>
                    <option value="back-office">BACK-OFFICE AUTOMATIONS</option>
                  </select>
                </div>
        ...
        <div className="max-w-6xl mx-auto px-6">
          <div className="flex flex-col items-center gap-6">
            ...
            <div className="text-center">
              <div className="chrome-logo mx-auto mb-4 w-fit">
